...
import drdoLogo from "../drdo-logo.png"; // adjust path if needed
...
const UploadPage = () => {
  ...
  return (
    <div
      className="w-screen h-screen bg-[#003366] flex items-center justify-center px-2 relative overflow-hidden"
      style={{
    ...
    >
      <div className="absolute w-screen h-screen bg-[#003366] opacity-90 z-0"></div>
