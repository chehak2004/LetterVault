...
const UploadPage = () => {
  ...
  return (
    <div className="w-screen h-screen bg-[#003366] flex items-center justify-center px-2 relative overflow-hidden">
      
      {/* DRDO Logo Background */}
      <div
        className="absolute inset-0 bg-center bg-contain bg-no-repeat opacity-10 blur-sm"
