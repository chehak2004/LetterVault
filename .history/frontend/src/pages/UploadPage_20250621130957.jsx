...
const UploadPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      fileUrl: "http://localhost:5000/uploads/dummy.pdf", // Placeholder for now
    };
  ...
  return (
    <div className="w-screen h-screen bg-[#003366] flex items-center justify-center px-2">
      <div className="bg-white shadow-md border border-gray-200 rounded-lg p-4 w-full max-w-xs">
